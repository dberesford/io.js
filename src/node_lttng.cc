...
void LTTNG_NET_SOCKET_READ(const FunctionCallbackInfo<Value>& args) {
...
void LTTNG_NET_SOCKET_WRITE(const FunctionCallbackInfo<Value>& args) {
...
#define NODE_PROBE(name) #name, name
    ...
    { NODE_PROBE(LTTNG_NET_SOCKET_READ) },
    { NODE_PROBE(LTTNG_NET_SOCKET_WRITE) },
